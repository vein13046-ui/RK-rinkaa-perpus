...
@section('content')
    <div class="space-y-6">
        ...
        <div id="userBorrowTable" class="overflow-hidden rounded-[2rem] border border-slate-100 bg-white shadow-xl shadow-slate-200/60">
            <table class="w-full text-left">
