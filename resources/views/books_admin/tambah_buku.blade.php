    ...
    <div class="bg-white rounded-3xl shadow-2xl border border-slate-200 p-10 mb-8">
        ...
        <form action="{{ route('admin.books.store') }}" method="POST" enctype="multipart/form-data" class="space-y-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                ...
                <div>
                    ...
                    <input type="text" id="judul" name="judul" required value="{{ old('judul') }}" 
                           class="w-full px-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm @error('judul') border-red-300 ring-2 ring-red-200 @enderror"
                ...
                <div>
                    ...
                    <input type="text" id="penulis" name="penulis" required value="{{ old('penulis') }}" 
                           class="w-full px-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm @error('penulis') border-red-300 ring-2 ring-red-200 @enderror"
                ...
                <div>
                    ...
                    <input type="text" id="kategori" name="kategori" required value="{{ old('kategori') }}" 
                           class="w-full px-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm @error('kategori') border-red-300 ring-2 ring-red-200 @enderror"
                ...
                <div>
                    ...
                    <input type="number" id="tahun_terbit" name="tahun_terbit" required value="{{ old('tahun_terbit') }}" min="1901" max="{{ date('Y')+1 }}"
                           class="w-full px-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm @error('tahun_terbit') border-red-300 ring-2 ring-red-200 @enderror"
                           placeholder="2024">
                    @error('tahun_terbit')
                        <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                    @enderror
            ...
            <div>
                ...
                <input type="number" id="stok" name="stok" required value="{{ old('stok', 1) }}" min="0" max="1000"
                       class="w-full px-5 py-4 border border-slate-200 rounded-2xl focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all shadow-sm @error('stok') border-red-300 ring-2 ring-red-200 @enderror"
                       placeholder="10">
                @error('stok')
                    <p class="mt-2 text-sm text-red-600">{{ $message }}</p>
                @enderror
            ...
            <div class="flex gap-4 pt-4">
                <a href="{{ route('admin.books.index') }}" class="flex-1 bg-slate-50 text-slate-700 hover:bg-slate-100 px-8 py-4 rounded-2xl font-semibold text-center transition-all shadow-sm border border-slate-200">
