...
<?php $__env->startSection('page-description', 'Lihat ringkasan koleksi dan akses buku dengan tampilan yang lebih tenang.'); ?>

<?php $__env->startSection('content'); ?>
    <div class="space-y-8">
        <div class="rounded-[2rem] bg-gradient-to-r from-slate-900 via-blue-900 to-indigo-800 p-8 sm:p-10 text-white shadow-2xl overflow-hidden relative">
            <div class="absolute inset-0 opacity-20 bg-[radial-gradient(circle_at_top_right,_white,_transparent_35%)]"></div>
            <div class="relative flex flex-col lg:flex-row lg:items-end lg:justify-between gap-8">
                <div class="max-w-2xl">
                    <p class="text-sm uppercase tracking-[0.24em] text-blue-100 font-semibold">Selamat datang</p>
                    <h3 class="mt-3 text-3xl sm:text-4xl font-black leading-tight">Halo, <?php echo e(Auth::user()->name); ?>.</h3>
                    <p class="mt-4 text-blue-50/90 text-base sm:text-lg leading-relaxed">
                        Semua informasi buku ditata agar mudah dibaca, cepat dipahami, dan nyaman dipakai sehari-hari.
                    </p>
                </div>
                <a href="<?php echo e(route('user.books')); ?>" class="inline-flex items-center justify-center gap-2 rounded-2xl bg-white px-5 py-3.5 font-semibold text-slate-900 shadow-lg shadow-black/10 transition hover:-translate-y-0.5">
...
<?php echo $__env->make('layouts.panel', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8882\htdocs\perpustakaan\resources\views/dashboard_user.blade.php ENDPATH**/ ?>