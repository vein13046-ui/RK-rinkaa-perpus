    ...
    <div class="w-full max-w-sm bg-white rounded-2xl p-8 shadow-xl shadow-slate-200/60 border border-slate-200">
        ...
        <form action="<?php echo e(route('login')); ?>" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="admin@sekolah.sch.id"
...
</html><?php /**PATH C:\xampp8882\htdocs\perpustakaan\resources\views/auth/login.blade.php ENDPATH**/ ?>