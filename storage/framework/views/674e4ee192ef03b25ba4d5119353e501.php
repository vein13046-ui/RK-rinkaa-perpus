        ...
        <div class="w-full max-w-6xl grid grid-cols-1 lg:grid-cols-2 gap-6 items-stretch">
            <div class="hidden lg:flex flex-col justify-between rounded-[2rem] bg-white/10 backdrop-blur-xl border border-white/15 p-10 text-white shadow-2xl">
                <div>
                    ...
                    <p class="mt-5 max-w-md text-base leading-relaxed text-slate-200/90">
                        Buat akun dengan alur yang sederhana, tampilan yang bersih, dan pengalaman yang terasa profesional.
                    </p>
                </div>
                <div class="grid grid-cols-2 gap-4">
                    <div class="rounded-3xl bg-white/10 p-5">
                        <p class="text-sm text-blue-100/80">Form singkat</p>
                        <p class="mt-2 text-2xl font-black">Cepat</p>
                    </div>
                    <div class="rounded-3xl bg-white/10 p-5">
                        <p class="text-sm text-blue-100/80">Identitas visual</p>
                        <p class="mt-2 text-2xl font-black">Seragam</p>
                    </div>
                </div>
            </div>
            ...
            <div class="rounded-[2rem] bg-white/95 backdrop-blur-xl border border-slate-200/70 shadow-2xl shadow-slate-900/10 p-6 sm:p-8 lg:p-10">
                <div class="flex items-center justify-between mb-8">
                    <div>
                        <p class="text-xs font-bold uppercase tracking-[0.24em] text-slate-400">Daftar</p>
                ...
                <div class="grid grid-cols-2 gap-2 rounded-2xl bg-slate-100 p-1 mb-6">
                    <a href="<?php echo e(route('login')); ?>" class="rounded-xl px-4 py-3 text-center text-sm font-semibold text-slate-500 transition hover:text-slate-800">Masuk</a>
                    <a href="<?php echo e(route('register')); ?>" class="rounded-xl bg-white px-4 py-3 text-center text-sm font-bold text-slate-900 shadow-sm">Daftar</a>
                </div>
                ...
                <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-5">
                    <?php echo csrf_field(); ?>
                    <div>
                        <label class="mb-3 block text-sm font-semibold text-slate-700">Nama Lengkap</label>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div>
                        <label class="mb-3 block text-sm font-semibold text-slate-700">Alamat Email</label>
                        <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="contoh@sekolah.sch.id" required
                            class="w-full rounded-2xl border border-slate-200 bg-slate-50/70 px-4 py-3.5 text-slate-900 outline-none transition focus:border-blue-400 focus:bg-white focus:ring-4 focus:ring-blue-100">
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div>
                            <label class="mb-3 block text-sm font-semibold text-slate-700">Konfirmasi</label>
...
unset($__errorArgs, $__bag); ?>
                ...
                <p class="mt-6 text-center text-sm text-slate-500">
                    Sudah punya akun?
                    <a href="<?php echo e(route('login')); ?>" class="font-semibold text-blue-700 hover:text-blue-800">Masuk di sini</a>
                </p>
            </div>
        </div>
    </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH C:\xampp8882\htdocs\perpustakaan\resources\views/auth/register_clean.blade.php ENDPATH**/ ?>