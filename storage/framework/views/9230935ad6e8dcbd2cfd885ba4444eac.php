        ...
        <form action="<?php echo e(route('register')); ?>" method="POST" class="space-y-5">
            ...
            <div>
                ...
                <input type="text" name="name" value="<?php echo e(old('name')); ?>" placeholder="Masukkan nama lengkap"
                    class="w-full px-4 py-3 bg-slate-50 border <?php echo e($errors->has('name') ? 'border-red-300 ring-2 ring-red-200/50' : 'border-slate-200'); ?> rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition duration-200 <?php $__errorArgs = ['name'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500/20 border-red-500 <?php unset($message);
...
$message = $__bag->first($__errorArgs[0]); ?>
                    <p class="mt-1 text-xs text-red-600 ml-1"><?php echo e($message); ?></p>
                <?php unset($message);
if (isset($__messageOriginal)) { $message = $__messageOriginal; }
endif;
unset($__errorArgs, $__bag); ?>
            ...
            <div>
                ...
                <input type="email" name="email" value="<?php echo e(old('email')); ?>" placeholder="contoh@sekolah.sch.id"
                    class="w-full px-4 py-3 bg-slate-50 border <?php echo e($errors->has('email') ? 'border-red-300 ring-2 ring-red-200/50' : 'border-slate-200'); ?> rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition duration-200 <?php $__errorArgs = ['email'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500/20 border-red-500 <?php unset($message);
            ...
            <div class="grid grid-cols-1 sm:grid-cols-2 gap-4">
                <div>
                    ...
                    <input type="password" name="password" placeholder="••••••••"
                        class="w-full px-4 py-3 bg-slate-50 border <?php echo e($errors->has('password') ? 'border-red-300 ring-2 ring-red-200/50' : 'border-slate-200'); ?> rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition duration-200 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500/20 border-red-500 <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                ...
                <div>
                    ...
                    <input type="password" name="password_confirmation" placeholder="••••••••"
                        class="w-full px-4 py-3 bg-slate-50 border <?php echo e($errors->has('password_confirmation') ? 'border-red-300 ring-2 ring-red-200/50' : 'border-slate-200'); ?> rounded-xl text-slate-800 placeholder-slate-400 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition duration-200 <?php $__errorArgs = ['password_confirmation'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> ring-2 ring-red-500/20 border-red-500 <?php unset($message);
...
<?php /**PATH C:\xampp8882\htdocs\perpustakaan\resources\views/auth/register.blade.php ENDPATH**/ ?>