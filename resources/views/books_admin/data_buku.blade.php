...
@section('page-title', 'Katalog Buku - Admin')
...
Manajemen inventaris koleksi perpustakaan RinKa Perpus.
            ...
            <a href="{{ route('admin.books.create') }}" class="group inline-flex items-center gap-2 text-blue-600 hover:text-blue-700 font-bold text-sm tracking-tight transition-all">
                            ...
                            <td class="px-6 py-8 align-top">
                                <div class="max-w-xs">
                                    ...
                                    <div class="flex flex-wrap items-center gap-x-3 gap-y-1 mt-2">
                                        <span class="text-sm font-semibold text-slate-500">{{ $book->penulis }}</span>
